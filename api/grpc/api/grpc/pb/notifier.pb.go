...
const file_notifier_proto_rawDesc = "" +
	...
	"\tnotifiers\x18\x01 \x03(\v2\x19.notifier.v1.NotifierInfoR\tnotifiers*\xa9\x01\n" +
	...
	"\x1cNOTIFICATION_STATUS_RETRYING\x10\x062\xe2\x06\n" +
	...
	"\vHealthCheck\x12\x1f.notifier.v1.HealthCheckRequest\x1a .notifier.v1.HealthCheckResponse\x12S\n" +
...
var file_notifier_proto_goTypes = []any{
	...
	(*NotifierInfo)(nil),                   // 22: notifier.v1.NotifierInfo
	(*GetNotifiersRequest)(nil),            // 23: notifier.v1.GetNotifiersRequest
	(*GetNotifiersResponse)(nil),           // 24: notifier.v1.GetNotifiersResponse
	nil,                                    // 25: notifier.v1.Notification.MetadataEntry
	nil,                                    // 26: notifier.v1.NotificationResult.ProviderResponseEntry
	nil,                                    // 27: notifier.v1.SendNotificationRequest.MetadataEntry
	nil,                                    // 28: notifier.v1.GetStatsResponse.ByTypeEntry
	nil,                                    // 29: notifier.v1.GetStatsResponse.ByStatusEntry
...
var file_notifier_proto_depIdxs = []int32{
	...
	25, // 3: notifier.v1.Notification.metadata:type_name -> notifier.v1.Notification.MetadataEntry
	31, // 4: notifier.v1.Notification.created_at:type_name -> google.protobuf.Timestamp
	31, // 5: notifier.v1.Notification.scheduled_for:type_name -> google.protobuf.Timestamp
	31, // 6: notifier.v1.Notification.sent_at:type_name -> google.protobuf.Timestamp
	31, // 7: notifier.v1.NotificationResult.sent_at:type_name -> google.protobuf.Timestamp
	26, // 8: notifier.v1.NotificationResult.provider_response:type_name -> notifier.v1.NotificationResult.ProviderResponseEntry
	...
	27, // 11: notifier.v1.SendNotificationRequest.metadata:type_name -> notifier.v1.SendNotificationRequest.MetadataEntry
	31, // 12: notifier.v1.SendNotificationRequest.scheduled_for:type_name -> google.protobuf.Timestamp
	...
	31, // 19: notifier.v1.NotificationFilter.created_after:type_name -> google.protobuf.Timestamp
	31, // 20: notifier.v1.NotificationFilter.created_before:type_name -> google.protobuf.Timestamp
